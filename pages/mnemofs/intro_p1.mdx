...
So, we glanced over the basic knowledge required to start learning about file systems. The fun and games end here, and in [Part II]({next}), it's time to dive into the depths of file systems, and file system development.
