...
Without diving into too much details, a lot of OSes also have an interface similar to a VFS for device drivers, which includes drivers for storage devices.
...
![fs](https://res.cloudinary.com/dbzi2yvvc/image/upload/v1716198473/Screenshot_20240520_151422_ocimv9.png)
...
Here we learnt how FS interacts with the OS, and in [Part III]({partthree}), we'll dive into FS and the various solutions that have emerged through the decades to an apparently "simple problem".

---

<Cards>
<Card icon="❰&emsp;" title="Part I" href={partone} />
<Card icon="❱&emsp;" title="Part III" href={partthree} />
</Cards>