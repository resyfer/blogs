...
export let prev = "./intro_p1";
export let next = "./intro_p3";
...
Here we learnt how FS interacts with the OS, and in [Part III]({next}), we'll dive into FS and the various solutions that have emerged through the decades to an apparently "simple problem".
